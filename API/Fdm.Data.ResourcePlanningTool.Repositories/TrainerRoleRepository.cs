...
{
    public class TrainerRoleRepository : GenericRepository<ResourcePlanningToolContext, TrainerRole>, ITrainerRoleRepository
    {
        public TrainerRoleRepository(ResourcePlanningToolContext context) : base(context)
        {
        }
    }
}