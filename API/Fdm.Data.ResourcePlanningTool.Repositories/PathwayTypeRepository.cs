...
{
    public class PathwayTypeRepository : GenericRepository<ResourcePlanningToolContext, PathwayType>, IPathwayTypeRepository
    {
        public PathwayTypeRepository(ResourcePlanningToolContext context) : base(context)
        {
        }
    }
}