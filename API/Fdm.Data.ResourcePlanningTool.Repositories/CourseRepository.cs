...
{
    public class CourseRepository : GenericRepository<ResourcePlanningToolContext, Course>, ICourseRepository
    {
        public CourseRepository(ResourcePlanningToolContext context) : base(context)
        {
        }
    }
}