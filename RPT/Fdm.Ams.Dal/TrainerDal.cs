...
namespace Fdm.Ams.Dal
{
    ...
    {
        private readonly string apiUrl = "/rpt/trainers";
        ...
        public TrainerDal(HttpClient httpClient,
        ...
        public async Task<IEnumerable<Trainer>> GetAllAsync()
        {
            ...
            return await response.Content.ReadAsAsync<IEnumerable<Trainer>>();
        }
        ...
        public async Task<Trainer> GetByIdAsync(int id)
        {
            ...
            return await response.Content.ReadAsAsync<Trainer>();
        }

        public async Task<Trainer> PostAsync(Trainer trainer)
        {
        ...
        public async Task<Trainer> PutAsync(Trainer trainer)
        {
            var json = JsonConvert.SerializeObject(trainer);
            var putContent = new StringContent(json, UnicodeEncoding.UTF8, "application/json");

            var response = await httpClientWrapper.PutAsync(httpClient, $"{route}/{trainer.Id}", putContent);
