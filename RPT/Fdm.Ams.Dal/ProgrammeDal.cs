...
namespace Fdm.Ams.Dal
{
    ...
    {
        private readonly string apiUrl = "/rpt/programmes";
        ...
        public ProgrammeDal(HttpClient httpClient,
        ...
        public async Task<IEnumerable<Programme>> GetAllAsync()
        {
            ...
            return await response.Content.ReadAsAsync<IEnumerable<Programme>>();
        }
        ...
        public async Task<Programme> GetByIdAsync(int id)
        {
            ...
            return await response.Content.ReadAsAsync<Programme>();
        }

        public async Task<Programme> PostAsync(Programme programme)
        {
        ...
        public async Task<Programme> PutAsync(Programme programme)
        {
            var json = JsonConvert.SerializeObject(programme);
            var putContent = new StringContent(json, UnicodeEncoding.UTF8, "application/json");

            var response = await httpClientWrapper.PutAsync(httpClient, $"{route}/{programme.Id}", putContent);
